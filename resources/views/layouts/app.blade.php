        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('projects.index') }}">Smart Agro
                            Projects</a></li>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    ...
                    <p>Invest in agriculture through managed projects, ethical field operations, verified products, and
                        farmer-centered execution.</p>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <span><a href="{{ route('refund') }}">Refund Policy</a> · <a href="{{ route('delivery') }}">Delivery
                        Policy</a> · <a href="{{ route('terms') }}">Terms & Conditions</a> · <a
